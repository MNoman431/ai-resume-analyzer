...
//           <div
//             key={i}
//             className={`p-8 rounded-[2.5rem] border flex flex-col transition-all duration-300 ${plan.popular ? "border-emerald-600 bg-card shadow-2xl scale-105" : "border-border bg-background"}`}
//           >
...
//                 >
//                   <Check size={18} className="text-emerald-600" /> {f}
//                 </li>
//               ))}
//             </ul>
